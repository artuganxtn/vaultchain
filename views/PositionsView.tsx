        ...
        <div className="space-y-6">
            ...
            <div className="flex bg-gray-200 dark:bg-gray-800 rounded-lg p-1">
                <button 
                    ...
                    className={`w-full py-2 rounded-md transition-colors text-sm font-semibold ${activeTab === 'discover' ? 'bg-white dark:bg-gray-700 shadow text-green-600 dark:text-green-400' : 'text-gray-600 dark:text-gray-300'}`}
                >
                    {t('discoverTraders')}
                </button>
                <button 
                    onClick={() => setActiveTab('subscriptions')} 
                    className={`w-full py-2 rounded-md transition-colors text-sm font-semibold ${activeTab === 'subscriptions' ? 'bg-white dark:bg-gray-700 shadow text-green-600 dark:text-green-400' : 'text-gray-600 dark:text-gray-300'}`}
                >
                    {t('mySubscriptions')}
                </button>
            </div>
