...
// FIX: Changed to a named export to resolve the import error.
        ...
        <div className="space-y-6">
            ...
            {user.isAgent && (
                 <div className="flex bg-gray-200 dark:bg-gray-800 rounded-lg p-1">
                    <button onClick={() => setActiveTab('referrals')} className={`w-full py-2 rounded-md transition-colors text-sm font-semibold ${activeTab === 'referrals' ? 'bg-white dark:bg-gray-700 shadow text-green-600 dark:text-green-400' : 'text-gray-600 dark:text-gray-300'}`}>{t('referrals')}</button>
                    <button onClick={() => setActiveTab('team')} className={`w-full py-2 rounded-md transition-colors text-sm font-semibold ${activeTab === 'team' ? 'bg-white dark:bg-gray-700 shadow text-green-600 dark:text-green-400' : 'text-gray-600 dark:text-gray-300'}`}>{t('myTeam')}</button>
                </div>
            )}
