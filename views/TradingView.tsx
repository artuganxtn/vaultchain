            ...
            <div className="flex-grow relative overflow-hidden">
                ...
                <div 
                    className={`
                        ...
                        ${isDrawerOpen ? 'translate-y-0' : 'translate-y-[calc(100%-72px)]'}
                    `}
                >
                    {/* Drawer Handle / Peek View */}
                    <div 
                        className="flex flex-col items-center justify-start pt-3 h-[72px] cursor-pointer"
                    ...
                    <div className="p-3 pt-0 space-y-3">
                        <div className="flex bg-gray-200/60 dark:bg-gray-900/50 rounded-lg p-1">
                            <button 
                                disabled 
                                className={`w-full py-2 rounded-md transition-colors text-sm font-bold ${tradeType === 'BUY' ? 'bg-green-500/50 text-white/70 shadow cursor-not-allowed' : 'text-gray-400 dark:text-gray-500 cursor-not-allowed'}`}
                            >
                                {t('buy')}
                            </button>
                            <button 
                                disabled 
                                className={`w-full py-2 rounded-md transition-colors text-sm font-bold ${tradeType === 'SELL' ? 'bg-red-500/50 text-white/70 shadow cursor-not-allowed' : 'text-gray-400 dark:text-gray-500 cursor-not-allowed'}`}
                            >
                                {t('sell')}
                            </button>
                        </div>
                        ...
                        <div className="text-xs text-gray-500 dark:text-gray-400 flex justify-between opacity-50">
                        ...
                        <button
                            disabled
                            className="w-full py-3 text-base font-bold rounded-xl text-gray-400 dark:text-gray-500 bg-gray-300 dark:bg-gray-700 cursor-not-allowed shadow-lg"
                        >
                           {t('comingSoon')}
                        </button>
                    </div>
