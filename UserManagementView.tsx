...
const UserRow: React.FC<{ user: User; onSelectUser: (user: User) => void }> = ({ user, onSelectUser }) => {
    ...
    return (
        <tr className="border-b border-gray-200 dark:border-gray-700/50 hover:bg-gray-50 dark:hover:bg-gray-800/20 cursor-pointer" onClick={() => onSelectUser(user)}>
            ...
            <td className="p-4 text-sm text-gray-900 dark:text-white font-mono whitespace-nowrap">{user.balance.toLocaleString('en-US', { style: 'currency', currency: 'USD' })}</td>
    ...
    return (
        <>
            <div className="space-y-6">
                ...
                <div className="bg-white dark:bg-[#062E1F]/80 backdrop-blur-sm border border-gray-200 dark:border-green-400/20 rounded-2xl shadow-md overflow-hidden">
                        ...
                        <table className="w-full text-left">
                            ...
                            <tbody className="divide-y divide-gray-200 dark:divide-gray-700/50">
                                {filteredUsers.length > 0 ? (
                                    filteredUsers.map(user => <UserRow key={user.id} user={user} onSelectUser={setSelectedUser} />)
                                ) : (
                                    <tr>
