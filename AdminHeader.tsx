...
import { BellIcon, SunIcon, MoonIcon, LogoutIcon, GlobeAltIcon } from './components/ui/Icons';
        ...
        <header className="bg-white dark:bg-[#062E1F] border-b border-gray-200 dark:border-green-400/20 h-16 flex-shrink-0">
            <div className="flex items-center justify-between h-full px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center space-x-2 sm:space-x-4">
                    <button
                        onClick={toggleTheme}
                        className="p-2 rounded-full text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700/50 hover:text-gray-500 dark:hover:text-gray-300"
                    >
