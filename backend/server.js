...
- For production deployment on a server (like AWS EC2), this Node.js application will run behind a web server like NGINX. NGINX will handle requests from your domain (https://vaultchaintr.com) and forward them internally to this application.
...
initDb().then(() => {
    ...
    app.listen(PORT, '0.0.0.0', () => {
        ...
        console.log(`API Base URL: https://vaultchaintr.com/api`);
        console.log(`=================================================`);
    });
}).catch(err => {
