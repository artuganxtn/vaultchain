...
const TransactionReceipt: React.FC<TransactionReceiptProps> = ({ transaction, sender, recipient }) => {
        ...
        <div className="bg-white text-gray-800 p-8 font-sans max-w-md mx-auto border border-gray-200 shadow-lg">
            ...
            <section className="mb-4">
                ...
                <div className="space-y-4">
                    ...
                    <ParticipantDetail title={t('receipt_recipient', 'Recipient')} name={recipient?.name} accountId={recipient?.accountNumber} />
                </div>
            </section>
            ...
            <section>
                 ...
                 <div className="space-y-2 text-xs text-center bg-gray-50 p-4 rounded-lg">
                    <p><strong>Email:</strong> support@vaultchaintr.com</p>
                    <p><strong>Phone:</strong> +905378299444 | +905074302420</p>
                    <p><strong>Website:</strong> vaultchaintr.com</p>
