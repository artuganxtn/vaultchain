...
const TraderDetailView: React.FC<TraderDetailViewProps> = ({ trader, user, onBack, onSubscribe, onAddReview, isVerified, onVerifyClick }) => {
    ...
    return (
        <>
            <div className="fixed inset-x-0 top-16 bottom-20 bg-gray-100 dark:bg-gray-900 z-30 flex flex-col">
                
                <div className="flex-shrink-0 p-2 sm:p-4 flex items-center space-x-2 sm:space-x-4 rtl:space-x-reverse border-b border-gray-200 dark:border-gray-700/50 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm">
                ...
                <div className="flex-grow overflow-y-auto scrollbar-hide">
                    <div className="p-4 sm:p-6 space-y-6">
                        ...
                        <Card>
                            <h3 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white">{'الأداء'}</h3>
                            <div className="h-60">
                ...
                <div className="flex-shrink-0 z-10 px-4 sm:px-6 py-3 bg-gradient-to-t from-gray-100 via-gray-100/80 to-transparent dark:from-gray-900 dark:via-gray-900/80 backdrop-blur-sm">
                    <button 
